...
use essential_types::{
    ...
    predicate::{self, Directive, Predicate},
    solution::{Mutation, Solution, SolutionData},
    PredicateAddress, Signature, Word,
};
...
pub fn sign_contract_with_random_keypair(contract: Contract) -> SignedContract {
    essential_sign::contract::sign(contract, &random_keypair().0)
}
